...
class KNNClassifier
    ...
    def __init__(self, kint,test_split_ratiofloat) - None
        self.k = k
    ...
    @staticmethod
    def load_csv(csv_pathstr)-Tuple[pd.DataFrame,pd.DataFrame]
    ...
    def train_set_split(self,featurespd.DataFrame,labelspd.DataFrame)
    ...
    def euclidean(self,element_of_xpd.DataFrame)
        return ((self.x_train - element_of_x)2).sum(axis=1)0.5
    
    def predict(self,x_testpd.DataFrame)
        labels_pred = []
